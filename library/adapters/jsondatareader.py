...
class BooksJSONReader:
    ...
    def read_json_files(self):
        ...
        for book_json in books_json:
            ...
            book_instance.publisher = pub_dict.setdefault(book_json['publisher'],Publisher(book_json['publisher']))
            ...
            for author_id in list_of_authors_ids:
                ...
                unique_author = author_dict.setdefault(author_name,Author(numerical_id, author_name))
                book_instance.add_author(unique_author)
