...
import library.authentication.service as service
...
def login():
    ...
    if form.validate_on_submit():
        ...
        try:
            user = service.get_user(form.user_name.data, repo.repo_instance)

            # Authenticate user.
            service.authenticate_user(user['user_name'], form.password.data, repo.repo_instance)
